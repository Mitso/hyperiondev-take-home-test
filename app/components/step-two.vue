<template>
     <!-- Form -->
    <form @submit="handleSubmit" class="bootcamp-reg-form step-2 max-w-4xl mx-auto">
...
const handleSubmit = () => {
  // Emit the data to the parent component for final submission
  emit('submit', { step: 2, data: form });
};
</script>